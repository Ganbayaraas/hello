angular.module("intro.Ctrl", []).controller("introCtrl", function ($ionicSlideBoxDelegate, $scope) {
  ...
  vm.items = [
    { title: "Та зээлийн ДИЖИТАЛ маркетаас бүх төрлийн зээлийг хамгийн хүү багатайгаар авах боломжтой.", img: "img/man-img.png" },
    { title: "Харилцагчийн мэдээллийн нууцлал, аюулгүй байдлыг хамгаалж ажилладаг. ОУ-ын нууцлал, аюулгүй байдлын стандартыг нэвтрүүлэгч компани.", img: "img/man-img.png" },
    { title: "Харилцагчийн мэдээллийн нууцлал, аюулгүй байдлыг хамгаалж ажилладаг. ОУ-ын нууцлал, аюулгүй байдлын стандартыг нэвтрүүлэгч компани.", img: "img/man-img.png" },
  ];
